...
export const lawsOfUX: LawOfUX[] = [
  // ── Heuristic (10) ──
  {
    ...
    keyTakeaway:
      "Make primary actions large and position them near likely cursor locations.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Reduce visible options and use progressive disclosure to manage complexity.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Follow established design patterns unless there is a strong, validated reason to deviate.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Chunk content into groups of 5-9 and use formatting to aid scanning.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Accept varied input formats gracefully and normalize them behind the scenes.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Design celebratory moments at completion and smooth over pain points at the end.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Provide feedback within 400ms — use loading indicators when processing takes longer.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Set clear deadlines or constraints to encourage timely task completion.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Show progress and leave breadcrumbs for incomplete tasks to drive re-engagement.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Position key items at the beginning and end of lists, menus, and navigation bars.",
  ...
  // ── Gestalt (5) ──
  {
    ...
    keyTakeaway:
      "Use cards, borders, or background fills to visually group related content.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Use consistent spacing to signal relationships — close for related, far for distinct.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Simplify visual elements to their most basic forms to aid quick comprehension.",
    source: "Max Wertheimer, 1923",
  },
  {
    title: "Similarity",
    ...
    category: "gestalt",
    oneLiner:
      "Visually similar elements are perceived as part of the same group.",
    description:
    ...
    keyTakeaway:
      "Use consistent visual properties (color, shape, size) to indicate shared function.",
    source: "Max Wertheimer, 1923",
  },
  {
    ...
    category: "gestalt",
    oneLiner:
      "Connected elements are seen as more related than unconnected ones.",
    description:
    ...
    keyTakeaway:
      "Use lines or connectors to explicitly show relationships between elements.",
  ...
  // ── Principle (5) ──
  {
    ...
    category: "principle",
    oneLiner:
      "Attractive designs are perceived as easier to use than ugly ones.",
    description:
    ...
    keyTakeaway:
      "Invest in visual polish — it buys forgiveness for small friction points.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Visually differentiate the most important element to ensure it is noticed and recalled.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Absorb complexity in the system so users face the simplest possible interface.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Remove unnecessary steps, fields, and options — simplicity wins.",
  ...
  },
  {
    ...
    keyTakeaway:
      "Focus design energy on the few features that deliver most of the user value.",
